    ...
    <div className="tab flex">
      <div className="tab__wrapper flex">
        ...
        <div className="tab__controllers flex">
          <div
            className={tab === 1 ? "tab-controller active" : "tab-controller"}
            onClick={() => handleTab(1)}
          ></div>
          <div
            className={tab === 2 ? "tab-controller active" : "tab-controller"}
            onClick={() => handleTab(2)}
          ></div>
          <div
            className={tab === 3 ? "tab-controller active" : "tab-controller"}
            onClick={() => handleTab(3)}
          ></div>
          <div
            className={tab === 4 ? "tab-controller active" : "tab-controller"}
            onClick={() => handleTab(4)}
          ></div>
        </div>
        {tab === 1 && <FirstTab />}
