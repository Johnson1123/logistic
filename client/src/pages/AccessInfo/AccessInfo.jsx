  ...
  return (
    <div className='info-access flex center'>
        ...
        <div className="info-content flex">
            <h3 className='form-title p-text'><span>XLCAB </span>TRANSFER</h3>
            <div className="info-modal">
                <div className="modal-1">
                    <p className="text-bold modal-title">Access to information</p>
                    <p className="p-text">Hi Rasheed, EduMe would like to receive the following data and permissions</p>
                </div>
                <div className="modal-2">
                    <p className="text-bold modal-title">Profile</p>
                    <p className="p-text">
                        You will be sharing your name, phone number and email 
                        address from your XLCABTRANSFER account.
                    </p>
                </div>
