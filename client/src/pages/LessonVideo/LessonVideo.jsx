...
function LessonVideo() {
    ...
    let List = () => {
        return ([...Array(numActivites)].map((e, i) => {
          return <div key={i} className='list-dot flex center'>{++i}</div>
        }))
      }
  return (
    <div className='LessonVideo flex'>
        ...
        <div className="LessonVideo__wrapper flex">
            <div className="LessonVideo__title-con flex"><span><FaAngleLeft /></span><p className='lesson-title p-text'>Introduction to the XLCABTRANSFER Partner app</p></div>
            <div className="profile__con flex">
                <div className="img__con"><img src={images.womanlearn} alt="" /></div>
                <div className="profile__content flex">
                    ...
                    <p className="p-text activity-qyt"><span>{numActivites}</span>activities</p>
                </div>
            </div>
