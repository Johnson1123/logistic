    ...
    <div className='Application'>
        <div className="top__container flex">
                <div className="desc">
                    ...
                    <p className="p-text">
                        You can find all drivers applications in this section. You can see their contact information, uploaded 
            ...
            <div className="scroll__container">
                ...
                <div className="data__container">
                    { !application ? <p className='p-text'>No pending driver applications.</p> : 
