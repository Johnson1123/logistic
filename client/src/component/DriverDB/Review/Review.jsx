                    ...
                    <div className='review__box flex' key={index} >
                       ...
                       <div className="col-2">
                        <div className="box p-text col-rating flex">
                            <p className='p-text small-title'>{review.name}</p><p className='p-text'> 
                            <Rate allowHalf count={5} value={review.rating} style={{color: 'green', fontSize: '12px', marginInlineEnd:0, padding: 0,}} disabled/>
                            </p>
                        </div>
