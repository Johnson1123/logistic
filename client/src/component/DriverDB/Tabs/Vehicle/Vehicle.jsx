                            ...
                            vehicles[toggle].documents.map((doc, index) => {
                                return (
                                    <div className="doc__box"key={index}>
                                        { true && <div className="expired__error">Document is expired</div>}
                                        ...
                                        <div className="doc__content flex">
                                            <div className="left__con">
                                                ...
                                                <div className="doc__icon flex"><TbFileInvoice /><p className="p-text">{doc.name}</p></div>
                                                <p className="p-text">Uploaded: {doc.Uploaded}</p>
                                                <p className="p-text">Expired: {doc.Expires}</p>
                                            </div>
                                            <div className="right__con flex">
                                                <label htmlFor="file-upload" className="custom-upload flex center p-text fw-500"><BiUpload /> Upload file</label>
            ...
            <div className="control__box-con">
                ...
                </div>
                {
                    vehicles.map((vehicle, index) => {
                        return (
                            <div className="control__box flex" onClick={() => handleToggle(index)} key={index}>
                                <div className="p-text control">{vehicle.model}({vehicle.year})</div>
