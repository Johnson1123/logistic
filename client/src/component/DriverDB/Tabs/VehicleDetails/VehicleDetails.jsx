...
function VehicleDetails() {
  return (
    <div className='VehicleDetails'>
         ...
         <p className="small-title">Driver can currently select this vehicle in the app.</p>
        <form action="" className='form__con'>
            <div className="input__group">
                <TabInput type='text' label='Model' placeholder='Toyota C-HR' name='Model' />
                <TabInput type='text' label='Year' placeholder='2022' name='year' />
            </div>
            <div className="input__group">
                <TabInput type='text' label='Number plate' placeholder='GG-081-JW' name='plate' />
