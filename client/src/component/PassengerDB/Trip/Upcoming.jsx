            ...
            return (
                <div className='trip__box flex box-shadow' key={trip._id} >
                   <div className="box p-text col-1 flex">
                        <div className="img__con"><img src={trip.image} alt="" /></div>
                   ...
                   <div className="box p-text col-3 flex">
                        ...
                        <div className="col__content-3">
                            <div className="pickUp flex"><span>{trip.takeOffPlace}</span><span className='sm-text'>{trip.takeOffTime}</span></div>
                            <div className="destination flex"><span>{trip.destination}</span><span className='sm-text'>{trip.arrivalTime}</span></div>
                        </div>
                   </div>
